...
class CardGameController extends AbstractController
{
    ...
    public function showDeck(SessionInterface $session): Response
    {
        ...
        // If deck is empty, generate and store a new one in the session
        if (empty($deck)) {
    ...
    #[Route("/card/deck/shuffle", name: "card_shuffle_page", methods: ["GET"])]
    public function shufflePage(SessionInterface $session): Response
    {
        $deck = $session->get('deck', []);
